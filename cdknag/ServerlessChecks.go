...
func (j *jsiiProxy_ServerlessChecks) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ServerlessChecks) RuleIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ruleIds",
...
func (j *jsiiProxy_ServerlessChecks) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
// Experimental.
func NewServerlessChecks(scope constructs.IConstruct, props *NagPackProps) ServerlessChecks {
	_init_.Initialize()
...
// Experimental.
func NewServerlessChecks_Override(s ServerlessChecks, scope constructs.IConstruct, props *NagPackProps) {
	_init_.Initialize()
...
func (s *jsiiProxy_ServerlessChecks) CheckResource(node awscdk.CfnResource) {
	if err := s.validateCheckResourceParameters(node); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_ServerlessChecks) Validate(context awscdk.IPolicyValidationContext) *awscdk.PolicyValidationPluginReport {
	if err := s.validateValidateParameters(context); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServerlessChecks) ValidateScope(scope constructs.IConstruct) *awscdk.PolicyValidationPluginReport {
	if err := s.validateValidateScopeParameters(scope); err != nil {
		panic(err)
	}
	var returns *awscdk.PolicyValidationPluginReport
